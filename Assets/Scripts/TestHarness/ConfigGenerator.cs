...
public class ConfigGenerator{
    ...
    public ConfigGenerator(){
        System.Console.WriteLine("=== entering ConfigGenerator.ConfigGenerator() ===");
    ...
    {  
        System.Console.WriteLine("=== entering ConfigGenerator.Shuffle() ===");
        int n = list.Count;  
        while (n > 1) {  
            n--;  
            int k = rnd.Next(n + 1);  
    ...
    private void getAllLevelInfo(){
        System.Console.WriteLine("=== entering ConfigGenerator.getAllLevelInfo() ===");
...
//            Debug.Log(levelDir);
    ...
    public void generateTestConfigFile(){
        System.Console.WriteLine("=== entering ConfigGenerator.generateTestConfigFile() ===");
    ...
    private void writeMetaConfigFile(string metaConfigPath){
        System.Console.WriteLine("=== entering ConfigGenerator.writeMetaConfigFile() ===");
        ...
        int[,] useTypes = {{1,2,4,5,11,13},{2,3,4,5,11,13},{1,2,3,4,8,9}};
		using (XmlWriter writer = XmlWriter.Create(output, ws))
		{
            ...
            for(int noveltyLevel = 1; noveltyLevel < 4; noveltyLevel ++){
                for(int typeIndex = 0; typeIndex < useTypes.GetLength(1); typeIndex++){
                    int noveltyType = useTypes[noveltyLevel-1,typeIndex];
                    ...
                    for(int i = 0; i < 50; i++){
                        ...
                        writer.WriteAttributeString("novelty_type","3");
                        writer.WriteAttributeString("amount","1-20");
    ...
    private void writeConfigFile(string configPath){
        System.Console.WriteLine("=== entering ConfigGenerator.writeConfigFile(): configPath=" + configPath);
...
//                              writer.WriteAttributeString("end",indexList[k].ToString());
    ...
    private void readTestGenerationConfig(string configMetaPath){
        System.Console.WriteLine("=== entering ConfigGenerator.readTestGenerationConfig() ===");

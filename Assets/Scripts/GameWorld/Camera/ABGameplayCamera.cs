...
public class ABGameplayCamera : MonoBehaviour {
	...
	void Awake()
	{
		//System.Console.WriteLine("=== entering ABGameplayCamera.Awake() ===");
		...
		//if (_camera == null) {
		//	System.Console.WriteLine("======== ABGameplayCamera.Awake(): _camera is NULL ========");
		//}

		//System.Console.WriteLine("=== exiting  ABGameplayCamera.Awake() ===");
	}
	
	void Update()
	{
		//System.Console.WriteLine("=== entering ABGameplayCamera.Update() ===");
		...
		//System.Console.WriteLine("=== exiting  ABGameplayCamera.Update() ===");
	}

...
public static class ABLevelUpdate{
    ...
    {
        //System.Console.WriteLine("calling ABLevelUpdate.RefreshLevelList()");
    ...
    public static string[] getAllXmlFiles(){
        //System.Console.WriteLine("=== entering ABLevelUpdate.getAllXmlFiles() ===");
        ...
        //System.Console.WriteLine("=== exiting  ABLevelUpdate.getAllXmlFiles() ===");

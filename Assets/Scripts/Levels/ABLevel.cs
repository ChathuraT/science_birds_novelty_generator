...
public class ExternalAgentData : OBjData
{

    public string material;

    public ExternalAgentData(string type, float rotation, float x, float y, string material)
    {
...
public class NoveltyData : OBjData
{
    public string material;
    public float scaleX;
    public float scaleY;
    ...
    public NoveltyData(string type, float rotation, float x, float y, string material, float scaleX, float scaleY)
    {
        this.type = type;
        this.rotation = rotation;
        this.x = x;
    ...
    public NoveltyData(string type, float rotation, float x, float y, string material, float scaleX, float scaleY, float forceMagnitude)
    {
        this.type = type;
        this.rotation = rotation;
        this.x = x;
...
//Adding the scenarioID data 
public struct IDData
{
    public string scenarioID;

    public IDData(string scenarioID)
    {
...
public class ABLevel
{
    ...
    public List<ExternalAgentData> externalagents;
    public List<NoveltyData> novelties;

    public static readonly int BIRDS_MAX_AMOUNT = 5;

    public ABLevel()
    {
        //System.Console.WriteLine("=== entering ABLevel.ABLevel() ===");
        ...
        externalagents = new List<ExternalAgentData>();
        novelties = new List<NoveltyData>();
        assetBundleFilePath = ABConstants.DEFAULT_ASSET_BUNDLE_FILE;
    }

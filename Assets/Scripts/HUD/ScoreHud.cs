...
public class ScoreHud : ABSingleton<ScoreHud> {
	...
	public void SpawnScorePoint(int point, Vector3 position) {
		// only update the score if the banner was not shown due to the ability of objects to move after they stabilize
		...
		if(ABGameWorld.isBannerShowing == false) {

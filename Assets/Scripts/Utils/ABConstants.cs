...
public class ABConstants
{
	...
	public static readonly int BLOCK_PARTCICLE_PER_SYSTEM = 30;
	...
	public static readonly string colorDataFileNoveltyGrayscale = Application.dataPath + "/Resources/Data/StreamingAssets/ColorCodes/BaseMapNoveltyGrayscale.json";
	...
	public static readonly string colorDataFileNoveltyGrayscale = Application.dataPath + "/StreamingAssets/ColorCodes/BaseMapNoveltyGrayscale.json";
...
public class ABWorldAssets
{
    ...
    public static readonly Dictionary<string, GameObject> EXTERNALAGENTS = LevelLoader.LoadABResource("Prefabs/GameWorld/ExternalAgents");
    public static readonly Dictionary<string, GameObject> NOVELTIES = LevelLoader.LoadABResource("Prefabs/GameWorld/Novelties");
    ...
    public static readonly PhysicsMaterial2D EXTERNALAGENT_MATERIAL = Resources.Load("Materials/ExternalAgent") as PhysicsMaterial2D;
}
